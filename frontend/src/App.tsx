          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            <div>
              <div className="flex items-center mb-4">
                ...
                <span className="text-xl font-bold">Tajik Trails</span>
              </div>
              <p className="text-gray-400 text-sm">
                Откройте для себя красоту Таджикистана с нашими уникальными турами и приключениями.
              </p>
            </div>
            
            <div>
              <h3 className="font-bold mb-4">Туры</h3>
              <ul className="space-y-2 text-sm text-gray-400">
                <li><a href="#" className="hover:text-white">Горные туры</a></li>
                <li><a href="#" className="hover:text-white">Культурные туры</a></li>
                <li><a href="#" className="hover:text-white">Приключения</a></li>
                <li><a href="#" className="hover:text-white">Шёлковый путь</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-400">
                ...
                <li><a href="#" className="hover:text-white">Отмена бронирования</a></li>
          ...
          <div className="border-t border-gray-800 pt-8">
            <div className="flex justify-between items-center">
              <div className="text-sm text-gray-400">
                © 2025 Tajik Trails. Все права защищены.
              </div>
