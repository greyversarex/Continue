...
- **Grid Layout for Categories**: Changed category cards back to responsive grid layout (1 column mobile, 2 columns tablet, 4 columns desktop) matching the proportions of tour cards in other sections
